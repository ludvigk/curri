...
class SubjectTest(TestCase):
    ...
    def test_home(self):
        ...
        subject_response = self.client.get(
            '/home/subject/' + Subject.objects.first().subjectID + '/')
...
class AddLectureTest(TestCase):
    ...
    def test_add_lecture(self):
        lecture_response = self.client.post('/home/add_lecture/' +
                                            Subject.objects.first().subjectID + '/',
                                            {"title": "Forelesning 1"})
...
class RemoveLectureTest(TestCase):
    ...
    def test_remove_lecture(self):
        remove_response = self.client.post('/home/remove_lecture/' +
                                           Subject.objects.first().subjectID + '/',
...
class StatisticsTest(TestCase):
    ...
    def test_statistics(self):
        stat_response = self.client.get(
            '/home/statistics/' + Subject.objects.first().subjectID + '/')
